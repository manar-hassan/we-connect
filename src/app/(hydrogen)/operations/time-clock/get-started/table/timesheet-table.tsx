...
import { getColumns as getTimesheetColumns } from './timesheet-column';
...
export default function TimesheetTable({
  ...
  const timesheetColumns = React.useMemo(
    () =>
      getTimesheetColumns({
        data,
        sortConfig,
  ...
  const {
    visibleColumns: visibleTimesheetColumns,
    checkedColumns: checkedTimesheetColumns,
    setCheckedColumns: setCheckedTimeSheetColumns,
  } = useColumn(timesheetColumns);
  ...
  return (
    <>
      <ControlledTable
        ...
        children={children}
        // @ts-ignore
        columns={visibleTimesheetColumns}
        paginatorOptions={{
          pageSize,
          setPageSize,
          total: totalItems,
