...
const classes = {
  table:
    '[&_.rc-table-content]:!overflow-visible [&_.rc-table]:unset [&_.rc-table]:border-none [&_table]:w-full [&_table]:relative [&_.rc-table-row:hover]:bg-gray-50 [&_.rc-table-row-expand-icon-cell]:w-14 ',
  thead:
    '[&_thead]:sticky [&_thead]:top-0 [&_thead]:text-left [&_thead]:rtl:text-right [&_thead]:border-b-2  [&_th.rc-table-cell]:text-sm [&_th.rc-table-cell]:font-normal [&_th.rc-table-cell]:tracking-wider [&_th.rc-table-cell]:text-gray-500 [&_th.rc-table-cell]:bg-[#f8f8f8] ',
  tCell:
    '[&_.rc-table-cell]:px-3 [&_td.rc-table-cell]:text-center [&_td.rc-table-cell]:mx-auto [&_th.rc-table-cell]:h-[54px] [&_td.rc-table-cell]:h-[45px] bg-white  [&_td.rc-table-cell]:whitespace-nowrap',
  variants: {
    classic:
...
export function ToggleColumns<T>({
  ...
  return (
    <div className="">
      <Popover
        content={() => (
          <div className="max-h-[250px] overflow-auto px-0.5 pt-2 text-left rtl:text-right">
        ...
        className="z-[1000] translate-x-4 overflow-hidden dark:bg-gray-100 [&>svg]:dark:fill-gray-100 [&_>_svg]:!left-[219.125px]"
      >
        <button>
          <PiTextColumns className=" h-6 w-6" />
        </button>
      </Popover>
    </div>
  );
