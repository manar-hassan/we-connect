export const routes = {
  communication: {
    ...
    directory: '/communication/directory',
    events: '/communication/events',
    knowledgeBase: '/communication/knowledge-base',
    surveys: '/communication/surveys',
  },
  operations: {
    timeClock: '/operations/time-clock',
    forms: '/operations/forms',
    jobScheduling: '/operations/job-scheduling',
    quickTasks: '/operations/quick-tasks',
  },
  hrAndSkills: {
    courses: '/hr-skills/courses',
    rewards: '/hr-skills/rewards',
    documents: '/hr-skills/documents',
    textMessages: '/hr-skills/text-messages',
    recognitions: '/hr-skills/recognitions',
    celebrations: '/hr-skills/celebrations',
    timeOff: '/hr-skills/time-off',
  },
  eCommerce: {
    dashboard: '/ecommerce',
